...
const NuevoPassword = () => {
    ...
    return (
        <>
            <div>
                <h1 className="text-indigo-600 font-black text-5xl">Reestablece tu password y no pierdas Acceso a tus <span className="text-black">Pacientes</span></h1>
            </div>
                    ...
                    <>
                        <form onSubmit={handleSubmit}>
                            <div className="my-5">
                                ...
                                <input type="password" placeholder="Tu Nuevo Password" name="password" className="border w-full p-3 mt-3 bg-gray-50 rounded-xl" value={password} onChange={e => setPassword(e.target.value)}/>
                            </div>
